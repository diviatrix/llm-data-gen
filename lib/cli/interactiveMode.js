...
async function createFromTemplate(configManager) {
  try {
    ...
    const userConfigsDir = (await import('../userPaths.js')).UserPaths.getUserConfigsDir();
...
async function openDataFolder() {
  try {
    const dataDir = UserPaths.getUserDataDir();
    ...
    console.info(`Please navigate to: ${UserPaths.getUserDataDir()}`);
  }
}
