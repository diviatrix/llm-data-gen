...
export class UserStorage {
  ...
  static getUserPreferencesPath(userId) {
    return path.join(this.getUserBaseDir(userId), 'preferences.json');
  }
  ...
  static async savePreferences(userId, prefs) {
    ...
    await fs.writeFile(prefPath, JSON.stringify(updated, null, 2));
  }
