...
class Router {
  ...
  async loadPageContent(route) {
    ...
    if (route !== '/') {
      ...
      wrapper.innerHTML = '<div class="text-center py-6"><h2 class="text-3xl font-bold mb-4">Welcome to LLM Data Generator</h2><p class="text-gray-600 mb-6">Generate AI-powered data using various language models</p><div class="grid-3 max-w-4xl mx-auto"><a href="#/generate" class="hover-card"><div class="text-3xl mb-3">🚀</div><h3 class="text-lg font-semibold mb-2">Generate Data</h3><p class="text-sm text-gray-600">Create data using your configurations</p></a><a href="#/files" class="hover-card"><div class="text-3xl mb-3">📁</div><h3 class="text-lg font-semibold mb-2">File Manager</h3><p class="text-sm text-gray-600">Manage configurations and results</p></a><a href="#/chat" class="hover-card"><div class="text-3xl mb-3">💬</div><h3 class="text-lg font-semibold mb-2">Chat</h3><p class="text-sm text-gray-600">Interact with AI models</p></a></div></div>';
    }
